...
if __name__ == "__main__":
    ...
    l =  ["Yasmina","Carolina","David","Nathan","Gerald","Florian","Nicolas","Thomas","Hervé","Maxence","Christian","Florian","Alexandre","Nathan","Pedro","Julien"]
    
    tri_rapide(l)
    print(l)

    val_recherche=input("Quel est le prénom que vous cherchez ?")
